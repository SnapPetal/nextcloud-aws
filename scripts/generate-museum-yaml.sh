...
for var in ENTE_POSTGRES_HOST ENTE_POSTGRES_USER ENTE_POSTGRES_PASSWORD ENTE_S3_ACCESS_KEY \
...
sed -e "s|ENTE_DB_HOST_PLACEHOLDER|$ENTE_POSTGRES_HOST|g" \
    -e "s|ENTE_DB_PORT_PLACEHOLDER|${ENTE_POSTGRES_PORT:-5432}|g" \
    -e "s|ENTE_DB_USER_PLACEHOLDER|$ENTE_POSTGRES_USER|g" \
